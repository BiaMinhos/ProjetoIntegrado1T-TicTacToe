...
void ST7735_WriteCharE(uint16_t x, uint16_t y, char ch, FontDef font, uint16_t color, uint16_t bgcolor) {
	ST7735_Select();
...
void ST7735_DrawLines()
{
	ST7735_FillScreen(BLACK);
	  for (int16_t x=0; x < ST7735_WIDTH; x+=6) {
		ST7735_DrawLine(0, 0, x, ST7735_HEIGHT-1, RED);
	    HAL_Delay(0);
	  }
	  for (int16_t y=0; y < ST7735_HEIGHT; y+=6) {
	    ST7735_DrawLine(0, 0, ST7735_WIDTH-1, y, GREEN);
	    HAL_Delay(0);
	  }

	  ST7735_FillScreen(BLACK);
	  for (int16_t x=0; x < ST7735_WIDTH; x+=6) {
	    ST7735_DrawLine(ST7735_WIDTH-1, 0, x, ST7735_HEIGHT-1, BLUE);
	    HAL_Delay(0);
	  }
	  for (int16_t y=0; y < ST7735_HEIGHT; y+=6) {
	  ...
	  ST7735_FillScreen(BLACK);
	  for (int16_t x=0; x < ST7735_WIDTH; x+=6) {
	    ST7735_DrawLine(0, ST7735_HEIGHT-1, x, 0, RED);
	    HAL_Delay(0);
	  }
	  for (int16_t y=0; y < ST7735_HEIGHT; y+=6) {
	    ST7735_DrawLine(0, ST7735_HEIGHT-1, ST7735_WIDTH-1, y, GREEN);
	    HAL_Delay(0);
	  }

	  ST7735_FillScreen(BLACK);
	  for (int16_t x=0; x < ST7735_WIDTH; x+=6) {
	    ST7735_DrawLine(ST7735_WIDTH-1, ST7735_HEIGHT-1, x, 0, BLUE);
	    HAL_Delay(0);
	  }
	  for (int16_t y=0; y < ST7735_HEIGHT; y+=6) {
